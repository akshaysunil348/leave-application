...
public class JDBCBinder extends FormBinder implements  FormLoadOptionsBinder, FormAjaxOptionsBinder, PluginWebSupport  {


    final static String MESSAGE_PATH = "messages/JDBCBinder";
    ...
    public String getPropertyOptions() {
        return AppUtil.readPluginResource(getClassName(), "/properties/jdbcbinder.json", null, true, MESSAGE_PATH);
    }
