...
public class ConditionDataListBinder extends DataListBinderDefault {
    ...
    public String getName() {
        return "Custom Condition Data List Binder";
    }
    ...
    public String getPropertyOptions() {
        return AppUtil.readPluginResource(getClassName(), "/properties/customcondition.json", null, true, MESSAGE_PATH);
    }
    ...
    protected String getQuerySelect(DataList dataList, Map properties) {
        ...
        String condition = getPropertyString("column");
        String value = getPropertyString("value");
        ...
        LogUtil.info("Custom Datalist Binder",tableName);
        LogUtil.info("Custom Datalist Binder",condition);
        LogUtil.info("Custom Datalist Binder",value);
        String sql = "SELECT " + selectColumns + " FROM " + tableName + " WHERE " + condition + "= '"+value+"' ORDER BY dateCreated DESC ;" ;
        return sql;
    }
